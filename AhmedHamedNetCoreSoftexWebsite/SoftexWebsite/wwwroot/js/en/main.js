!(function (a) {
    ...
    var b = {
        ...
        init: function () {
            if (!this.initialised) {
                ...
                "function" == typeof imagesLoaded &&
                    (imagesLoaded(b.container, function () {
        ...
        queryLoad: function () {
            ...
            a.fn.queryLoader2 &&
                a("body").queryLoader2({
                    ...
                    fadeOutTime: 200,
                    onComplete: function () {
                        a(".softex-loader-overlay").fadeOut(400, function () {
                            a(this).remove();
                        }),
                            b.scrollAnimations();
                    },
        ...
        toggleOverlayClick: function () {
            a(".softex-menu-overlay").on("click", function (b) {
        ...
        stickyMenu: function () {
            a.fn.waypoint && a(window).width() >= 992 && a(".sticky-menu").waypoint("sticky", { stuckClass: "fixed", offset: -300 });
        },
        ...
        sideMenuScrollbar: function () {
            if (a.fn.niceScroll) {
                ...
                a(".side-menu-wrapper").niceScroll({ zindex: 9999, autohidemode: !0, background: "rgba(0,0,0, 0.03)", cursorcolor: b, cursorwidth: "6px", cursorborder: "1px solid transparent", cursorborderradius: "4px", railalign: d });
            }
        },
        collapseArrows: function () {
            a(".category-widget-btn").on("click", function (b) {
                var c = a(this),
                    d = c.closest("li");
                d.hasClass("open")
                    ? d.find("ul").slideUp(400, function () {
                        d.removeClass("open");
                    })
        ...
        tabLavaHover: function () {
            a.fn.lavalamp && (a(".nav-tabs-lava").lavalamp({ setOnClick: !0, duration: 500, autoUpdate: !0 }), a(".nav-tabs-border").lavalamp({ setOnClick: !0, duration: 300, autoUpdate: !0 }));
        },
        ratings: function () {
        ...
        owlCarousels: function () {
            a(".owl-carousel.shop-arrivals-carousel-sm").owlCarousel({
                ...
                a(".owl-carousel.aboutus-slider").owlCarousel({ loop: !1, margin: 0, responsiveClass: !0, nav: !1, navText: ['<i class="fa fa-angle-left">', '<i class="fa fa-angle-right">'], dots: !0, items: 1 }),
                ...
                //a(".owl-carousel.testimonial-slider").owlCarousel({ loop: !1, margin: 0, responsiveClass: !0, nav: !1, navText: ['<i class="fa fa-angle-left">', '<i class="fa fa-angle-right">'], dots: !0, items: 1 }),
        ...
        priceSlider: function () {
            a("#price-range").noUiSlider({ range: [0, 1e3], start: [100, 900], handles: 2, connect: !0, serialization: { to: [a("#price-range-low"), a("#price-range-high")] } });
        },
        ...
        dateTimePicker: function () {
            a.fn.datetimepicker &&
                (a(".form-datetime").datetimepicker({ weekStart: 1, todayBtn: 1, autoclose: 1, todayHighlight: 1, startView: 2, forceParse: 0, showMeridian: 1 }),
                    a(".form-date").datetimepicker({ weekStart: 1, todayBtn: 1, autoclose: 1, todayHighlight: 1, startView: 2, minView: 2, forceParse: 0 }),
                    a(".form-time").datetimepicker({ weekStart: 1, todayBtn: 1, autoclose: 1, todayHighlight: 1, startView: 1, minView: 0, maxView: 1, forceParse: 0 }));
        },
        tooltip: function () {
        ...
        newsletterPopup: function () {
            document.getElementById("newsletter-popup-form") && jQuery.magnificPopup.open({ items: { src: "#newsletter-popup-form" }, type: "inline" }, 0);
        },
        lightBox: function () {
            a(".popup-gallery").magnificPopup({
                ...
                a(".popup-iframe").magnificPopup({ disableOn: 700, type: "iframe", mainClass: "mfp-fade", removalDelay: 160, preloader: !1, fixedContentPos: !1 });
        },
        videoBg: function () {
            if (!this.mobile) {
        ...
        flickerFeed: function () {
            a.fn.jflickrfeed &&
                (a("ul.flickr-widget-two").jflickrfeed({ limit: 8, qstrings: { id: "54297118@N03" }, itemTemplate: '<li><a href="{{image}}" title="{{title}}"><img src="{{image_s}}" alt="{{title}}" /></a></li>' }),
                    a("ul.flickr-widget-three").jflickrfeed({ limit: 15, qstrings: { id: "54297118@N03" }, itemTemplate: '<li><a href="{{image}}" title="{{title}}"><img src="{{image_s}}" alt="{{title}}" /></a></li>' }));
        },
        attachBg: function () {
        ...
        isotopeFilter: function () {
            ...
            c.find("a").on("click", function (d) {
                ...
                c.find(".active").removeClass("active"), b.container.isotope({ filter: f, transitionDuration: "0.8s" }), e.closest("li").addClass("active"), d.preventDefault();
            });
        },
        ...
        infiniteScroll: function (b, c) {
            a.fn.infinitescroll &&
                (b.infinitescroll(
                    { navSelector: "#page-nav", nextSelector: "#page-nav a:first", itemSelector: c, loading: { msgText: "Loading Posts...", finishedMsg: "No more post to load.", img: "//eonythemes.com/themes/t/images/load.GIF" } },
                    function (c) {
                        b.isotope("appended", a(c)).isotope("layout");
                    }
                ),
                    a("#infinite-trigger").length &&
                    (a(window).unbind(".infscr"),
                        a("#infinite-trigger").on("click", function (a) {
    ...
    b.init(),
        ...
        a.event.special.debouncedresize
    ...
    d.on("click", function (a) {
        ...
        i.on("click", function (c) {
            if (!a(this).hasClass("active")) {
                ...
                "boxed" === d ? g.removeClass("boxed-long").addClass("boxed") : "boxed-long" === d ? g.removeClass("boxed").addClass("boxed-long") : g.removeClass("boxed boxed-long"),
                    a.fn.isotope && b.isotopeReinit(),
                    a(this).addClass("active"),
                    a.cookie("layout", d, { expires: 1 });
            }
            c.preventDefault();
        }),
        ...
        a(function () {
            a.cookie("stylesheet") && f.attr("href", "css/colors/" + a.cookie("stylesheet")),
                a.cookie("layout") &&
                (a(".preview-color-box.active").removeClass("active"),
                    "boxed" === a.cookie("layout") ? g.removeClass("boxed-long").addClass("boxed") : "boxed-long" === a.cookie("layout") ? g.removeClass("boxed").addClass("boxed-long") : g.removeClass("boxed boxed-long"),
                    b.isotopeReinit()),
                a.cookie("pattern") && a("body").removeClass().addClass(a.cookie("pattern")),
                a("#preview-reset-btn").on("click", function (b) {
